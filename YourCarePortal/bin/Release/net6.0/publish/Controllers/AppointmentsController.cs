    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Appointments(string email, string password,string viewname)
        {
            ...
            else if (!string.IsNullOrEmpty(email) && !string.IsNullOrEmpty(password))
            {
                ...
                //var Authentication1 = await _authHelper.Authenticate(email, password);
                ...
                // Handle failed authentication by returning to the Index view with an error message
                //if (string.IsNullOrEmpty(Authentication1.AUTHKEY))
                //{
                //    TempData["ErrorMessage"] = "Email or password incorrect. Please try again.";
                //    return View("Index");
                //}
            ...
            //if (rootObject.Appointments == null)
            //{
            ...
            //catch (Exception e)
            //{
            //    // Log the exception and return to the Index view with an error message
        ...
        public IActionResult AppointmentsAction(DateTime? startDate, DateTime? endDate, int? clientId)
        {
            ...
            // if logging-in and have email
            //if (email != null)
            //{
            // Set Session Variables 
            // HttpContext.Session.SetString("portalUserEmail", "Gregg");
            //}
